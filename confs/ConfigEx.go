...
func InitLoad(wg *sync.WaitGroup) {
	...
	// Logger.PStatus("Config Load Map.")
	// conf.ConfigMap = InitConfigMap(CONFIG_PATH)
	// Logger.PStatus("Config Load Game.")
	// conf.ConfigGame = InitConfigGame(CONFIG_PATH)
	// Logger.PStatus("Config Load Furn.")
	// conf.ConfigFurn = InitConfigFurn(CONFIG_PATH)
	// Logger.PStatus("Config Load NPC.")
	// conf.ConfigNPC = InitConfigNPC(CONFIG_PATH)
	// Logger.PStatus("Config Load Hero.")
	// conf.ConfigHero = InitConfigHero(CONFIG_PATH)
	// Logger.PStatus("Config Load Item.")
	// conf.ConfigItem = InitConfigItem(CONFIG_PATH)
	// Logger.PStatus("Config Load MakeSlot.")
	// conf.ConfigMake = InitConfigMake(CONFIG_PATH)
	// Logger.PStatus("Config Load Player.")
	// conf.ConfigPlayer = InitConfigPlayer(CONFIG_PATH)
	// Logger.PStatus("Config Load Order.")
	// conf.ConfigOrder = InitConfigOrder(CONFIG_PATH)
	// Logger.PStatus("Config Load AVG.")
	// conf.ConfigAvg = InitConfigAvg(CONFIG_PATH)
	// Logger.PStatus("Config Load Skill.")
	// conf.ConfigSkill = InitConfigSkill(CONFIG_PATH)
	// Logger.PStatus("Config Load Task.")
	// conf.ConfigTask = InitConfigTask(CONFIG_PATH)
	ChackConfig(conf)
	ConfExample = conf
